...
export async function seedMerchContent(prisma: PrismaClient, tenantId: string): Promise<void> {
  ...
  const defs: readonly MerchDef[] = [
    ...
    },
    {
      ...
      ctaHref: '/demo/store/products?onSale=1',
    ...
    },
    {
      ...
      ctaHref: '/demo/store/products?category=electronics',
    ...
    },
    {
      ...
      ctaHref: '/demo/store/products?category=fashion-apparel',
