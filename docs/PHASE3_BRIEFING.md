...
# Target agent: Claude Opus 4.6 via Claude Code
# Spec version: PRODUCT.md (2,062 lines, ~90 entities, 97 pages, 13 roles, 23 queues)

---

## How to use this briefing

This document tells Claude Code everything it needs to scaffold and build Orqafy.
Read this file FIRST, then read the attached spec files in order:

1. `PRODUCT.md` — the complete product specification (2,062 lines, authoritative)
2. `DESIGN.md` — VoltAgent visual design reference (color tokens, typography, layout)
3. `DECISIONS_LOG.md` — append-only decision history (3 entries, all superseded to VoltAgent)
...
When you have read this briefing + PRODUCT.md + DESIGN.md + DECISIONS_LOG.md, reply:

*"Briefing acknowledged. I have the full Orqafy specification (2,062 lines, ~90 entities, 97 pages, 13 roles, 23 queues). Ready to begin Slice 1 — Foundation. Shall I start?"*

Then wait for instruction to begin.
