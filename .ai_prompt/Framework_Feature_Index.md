...
> Current framework version: **V32.45.1** — see the **V32.37** (Design-Fidelity Completion — R2/R3/R5/R6, extends Rule 31 further, counts unchanged), **V32.38** (App Audit Toolkit, new Rule 38, deliverables #35/#36, Scenario 48), **V32.39** (Dev-Freshness deliverable, new Rule 39, deliverable #37), **V32.39.1** (Audit-Gate Wiring — wires the Rule 38 Tier-2 Phase-5 opt-in gate; counts unchanged), **V32.40** (Capability-Primer regenerator, deliverable #38, no new Rule/Scenario), **V32.41** (Capability-Primer continuous self-refresh — spec-gap-check.sh #28 CLASS 5 + Phase 7 wiring, no count change), and **V32.42** (CI/CD Komodo Stack Registration Audit — extends Rule 36, `deploy/komodo-verify.sh`/`cicd-gen --audit`, no count change) rows below.
