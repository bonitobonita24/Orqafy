---
name: a11y-skill
description: WCAG 2.1 AA accessibility audit using axe-core (runtime) and eslint-plugin-jsx-a11y (static). Trigger on accessibility scan, a11y audit, WCAG compliance check, or any UI delivery gate requiring accessibility verification.
---
