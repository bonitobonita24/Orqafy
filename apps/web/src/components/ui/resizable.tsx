...
// react-resizable-panels v4 renamed PanelGroup/PanelResizeHandle → Group/Separator
// and dropped the data-panel-group-direction attribute — flex-direction is now
// applied internally via inline style based on the `orientation` prop.
