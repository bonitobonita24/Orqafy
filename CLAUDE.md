...
## THE 35 RULES (compact — full details in .ai_prompt/phases.md, other .ai_prompt/ files, and AI/Master_Prompt.md)
...
> includes step 0b — confirm the planned task does not violate any of the 35 Rules or the L1-L6 security
